...
// Pass index to the ...Create functions so that, for example, genre[0] will always be the Fantasy genre, 
// regardless of the order in which the elements of promise.all's argument complete.
